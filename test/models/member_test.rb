...
class MemberTest < ActiveSupport::TestCase
	before do
		@member = Member.new(name: "Joey Gaba", email: "joeygama@example.com", password: "foobar", password_confirmation: "foobar")
	end
	...
	describe "return value of authenticate method" do
		before { @member.save }
		let(:found_member) { Member.find_by_email(@user.email) }
